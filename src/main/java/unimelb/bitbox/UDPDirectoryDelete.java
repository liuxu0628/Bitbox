...
public class UDPDirectoryDelete {
     ...
     */
    /*public DirectoryDelete2(Socket socket) {
        this.socket = socket;
    }*/
     ...
     */
    public Document DirectoryDelete_request(FileSystemEvent event) throws IOException {
     ...
     * @throws IOException This is a mandatory exception when using I/O Stream.
     */
    public Document DirectoryDelete_response(Document req, FileSystemManager manager) throws IOException {

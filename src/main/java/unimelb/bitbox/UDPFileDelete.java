...
public class UDPFileDelete {
     ...
     */
    public UDPFileDelete(/*Socket socket*/) {
       /* this.socket = socket;*/
    }
     ...
     */
    public Document FileDelete_request(FileSystemManager.FileSystemEvent event) throws IOException {
...
//            return res;
     ...
     */
    public Document FileDelete_response(Document req, FileSystemManager manager) throws IOException, NoSuchAlgorithmException {
    ...
    private String FileDelete_process(Document req, FileSystemManager manager) throws NoSuchAlgorithmException, IOException {
        ...
        if (manager.isSafePathName(pathname)) {
            ...
            if (manager.fileNameExists(pathname, md5)) {
                manager.createFileLoader(pathname, md5, length, lastModified);

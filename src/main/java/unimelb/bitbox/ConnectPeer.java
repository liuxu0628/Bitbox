...
public class ConnectPeer {
     ...
     */
    public ConnectPeer(Socket socket, String sessionKey, HostPort hostPort) {
        this.socket = socket;
    ...
    public void ConnectPeer_request() throws IOException, NullPointerException {
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(socket.getOutputStream(), "UTF8"));

        Document payload = new Document();
        payload.append("command", "CONNECT_PEER_REQUEST");
     ...
     */
    public void ConnectPeer_response(boolean status) throws IOException {
        BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(socket.getOutputStream(), "UTF8"));
        ...
        String message = status ? "connected to peer" : "connection failed";
